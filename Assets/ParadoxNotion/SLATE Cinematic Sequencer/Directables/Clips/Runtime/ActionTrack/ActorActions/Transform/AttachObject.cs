...
namespace Slate.ActionClips{
	...
	public class AttachObject : ActorActionClip {
		...
		void Do(){
			...
			var actorTransform = ResolveTransform(childTransformName);
			...
			targetObject.SetParent(actorTransform);
		...
		Transform ResolveTransform(string name){
