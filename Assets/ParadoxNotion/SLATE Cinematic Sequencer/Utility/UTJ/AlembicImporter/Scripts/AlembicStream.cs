...
namespace UTJ
{
    ...
    public class AlembicStream : MonoBehaviour
    {
        ...
        [Header("Abc")]
        [HideInInspector] public string m_pathToAbc;
        [HideInInspector] public float m_time;
    
        [Header("Playback")]
        [HideInInspector] public float m_startTime = 0.0f;
        [HideInInspector] public float m_endTime = 0.0f;
        [HideInInspector] public float m_timeOffset = 0.0f;
        [HideInInspector] public float m_timeScale = 1.0f;
        [HideInInspector] public bool m_preserveStartTime = true;
        [HideInInspector] public CycleType m_cycle = CycleType.Hold;
        ...
        [Header("Diagnostic")]
        [HideInInspector] public bool m_verbose = false;
        [HideInInspector] public bool m_logToFile = false;
        [HideInInspector] public string m_logPath = "";
        
        [Header("Advanced")]
        [HideInInspector] public bool m_useThreads = false;
        [HideInInspector] public int m_sampleCacheSize = 0;
        [HideInInspector] public bool m_forceRefresh;
