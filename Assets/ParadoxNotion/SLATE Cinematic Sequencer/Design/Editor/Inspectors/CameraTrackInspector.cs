...
namespace Slate{
	...
	public class CameraTrackInspector : CutsceneTrackInspector {
		...
		public override void OnInspectorGUI(){
			...
			track._blendIn = EditorGUILayout.Slider("Blend In", track._blendIn, 0, length/2);
			track._blendOut = EditorGUILayout.Slider("Blend Out", track._blendOut, 0, length/2);
			...
			GUILayout.BeginVertical("box");
			track.appliedSmoothing = EditorGUILayout.Slider("Post Smoothing", track.appliedSmoothing, 0, 3f);
			GUILayout.EndVertical();
